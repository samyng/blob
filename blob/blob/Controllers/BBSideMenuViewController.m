...
@interface BBSideMenuViewController ()
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kSideMenuTableCellIdentifier forIndexPath:indexPath];
